...
%               xr(3,t-1)+u(2,t)*dt] + e;
    ...
    xr(:,t) = xr(1,t-1) + [dt*(v)*cos(xr(3,t-1)) ; dt*(v)*sin(xr(3,t-1))  ; dt*(1/l)*(v)*tan(steerAngleRad)] + E;
    ...
    % Prediction update
    mu(1:3) = [mu(1)+v*cos(mu(3))*dt;
           mu(2)+v*sin(mu(3))*dt;
           mu(3)+steerAngleRad*dt];
    
    Gt = [ 1 0 -v*sin(mu(3))*dt;
           0 1 v*cos(mu(3))*dt;
           0 0 1];
