% Multi-rate Kalman filter example - This example is an extension of the 2d
% example. The multi-rate stuff is explaied on slides 89-91. Basically one
% measurement is very good but takes 10 timesteps, the other is meh but happens
% every timestep.
