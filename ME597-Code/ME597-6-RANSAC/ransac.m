...
% NLLS ==> NON LINEAR LEAST SQUARES PROBLEM
...
% Plot on slide mapping 1 - 36 (simulation)
...
% This is while loop in slides Mapping 1 - 31
for k = 1:RANSAC_iters
    ...
    % 1. Pick samples to use for solution
    sample_ind = ceil(meas_count*rand(sample,1));
    
    % 2. Solve NLLS to find robot position
    ...
    % 4. Save biggest inlier set in the loop so you can select it outside loop
...
% 5. Resolve NLLS with biggest inlier set (iterate on measurement update)
...
% Result plot on slide mapping 1 - 41
